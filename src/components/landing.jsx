                                ...
                                <div className="top-header">
                                            ...
                                            <div className={`collapse navbar-collapse ${this.state.toggle?'show':''}`} id="scroll-spy">
                                                <ul className="navbar-nav mx-auto nav">
                                                    <li className="nav-item">
                                                        <a className="nav-link active" href="#img-bg">Home</a>
                                                    </li>
                                                    <li className="nav-item">
                                                    ...
                                                    <li className="nav-item">
                                                        <a className="nav-link" href="#email">email templates</a>
                                                    </li>
                                                    <li className="nav-item">
                                                        <a className="nav-link" href="#core">core feature</a>
                                                    </li>
                                                    <li className="nav-item">
                                    ...
                                    <div>
                                        <form target="_blank" className="form-inline my-lg-0"
                                              action="https://themeforest.net/item/multikart-responsive-ecommerce-html-template/22809967?s_rank=3">
                                ...
                                <div className="feature-box">
                                    <div className="feature-image">
                                        <img className="img-fluid lazyload"
                                             src={`${process.env.PUBLIC_URL}/assets/images/landing-page/main-features/SEO-Support.png`} alt="img" />
                                    </div>
                                    ...
                                    <p className="para">Fully SEO Support Feature, Easy to Manage SEO KeyWords, titles and Metatags.</p>
                                </div>
                            </div>
                            <div className="col-xl-3 col-md-6 ">
                                <div className="feature-box">
                                    <div className="feature-image">
                                        <img className="img-fluid lazyload"
                                             src={`${process.env.PUBLIC_URL}/assets/images/landing-page/main-features/Therme-Element.png`}
                                             alt="img" />
                                    </div>
                                    <div className="feature-content">
                                        <ul className="color-varient">
                                    ...
                                    <p className="para">Easy customization (no code needed) 10+ Exaples provided in multikart</p>
                                </div>
                            </div>
                            <div className="col-xl-3 col-md-6">
                                <div className="feature-box">
                                    ...
                                    <p className="para">Useful feature for Night Owls or people who work during the
                                        night. The dark background will put less strain on the eyes.</p>
                                </div>
                            </div>
                            <div className="col-xl-3 col-md-6">
                                <div className="feature-box">
                                    <div className="feature-image">
                                        <img className="img-fluid lazyload"
                                             src={`${process.env.PUBLIC_URL}/assets/images/landing-page/main-features/rtl.png`} alt="img" />
                                    </div>
                                    <div className="feature-content">
                                        <ul className="color-varient">
                                            <li className="red"></li>
                                    ...
                                    <p className="para">Design your website LTR or RTL , Multikart supports
                                        multi-languages so its easy to design website on any layout such as arabic ,
                                        urdu..</p>
                                </div>
                            </div>
                        </div>
